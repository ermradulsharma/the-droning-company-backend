...
class ProfileImageCrop implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(PilotProfile $pilotprofile)
    {
        $this->profile=$pilotprofile;
    }
    ...
    public function handle()
    {
        ...
        $destinationPath=public_path('/images/'.$this->profile->id.'/profile');
