...
class GalleryImageCrop implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(PilotGallery $pilotGallery)
    {
        $this->gallery=$pilotGallery;
    }
    ...
    public function handle()
    {
        ...
        $destinationPath=public_path('/images/'.$this->gallery->pilot_profile_id.'/gallery');
