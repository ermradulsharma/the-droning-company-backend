...
.card-data .custom-file img{width:100px; height: 80px;object-fit: contain;border: 1px solid #eee;}</style>
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.company.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('suite') ? 'is-invalid' : '' }}" type="text" name="suite" id="suite" value="{{ old('suite') }}" required>
                        @if($errors->has('suite'))
                ...
                <!--<div class="col-md-4">
                    <div class="form-group">
                        <label class="required" for="country_id">{{ trans('cruds.CompanyManagement.fields.country') }}</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="" for="service_1">{{ trans('cruds.CompanyManagement.fields.service_1') }}</label>
                        <input class="form-control {{ $errors->has('service_1') ? 'is-invalid' : '' }}" type="text" name="service_1" id="service_1" value="{{ old('service_1') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="" for="service_2">{{ trans('cruds.CompanyManagement.fields.service_2') }}</label>
                        <input class="form-control {{ $errors->has('service_2') ? 'is-invalid' : '' }}" type="text" name="service_2" id="service_2" value="{{ old('service_2') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="" for="service_3">{{ trans('cruds.CompanyManagement.fields.service_3') }}</label>
                        <input class="form-control {{ $errors->has('service_3') ? 'is-invalid' : '' }}" type="text" name="service_3" id="service_3" value="{{ old('service_3') }}">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="form-group card-data">
                        <label class="required" for="customFile">Company Logo</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input {{ $errors->has('logo') ? 'is-invalid' : '' }}" id="customFile" name="logo" value="{{ old('logo', '') }}" onchange="loadFile(event)" required >
                    ...
                    <div class="form-group card-data">
                        <div class="custom-file" style="height: auto;">
                            <img id="output" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Logo Preview Image" width="100">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group card-data">
                        <label class="required" for="customFile1">Company Featured Image</label>
                        <div class="custom-file">
                    ...
                    <div class="form-group card-data">
                        <div class="custom-file" style="height: auto;">
                            <img id="output_featured" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview Featured Image" width="100">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_1" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="profile_img_1 Preview Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_1">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_1') ? 'is-invalid' : '' }}" name="pic_desc_1" id="pic_desc_1" placeholder="Profile Image 1 Description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_2" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview profile_img_2 Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_2">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_2') ? 'is-invalid' : '' }}" name="pic_desc_2" id="pic_desc_2" placeholder="Profile Image 2 Description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_3" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview profile_img_3 Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_3">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_3') ? 'is-invalid' : '' }}" name="pic_desc_3" id="pic_desc_3" placeholder="Profile Image 3 Description"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_4" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview profile_img_4 Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_4">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_4') ? 'is-invalid' : '' }}" name="pic_desc_4" id="pic_desc_4" placeholder="Profile Image 4 Description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_5" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview profile_img_5 Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_5">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_5') ? 'is-invalid' : '' }}" name="pic_desc_5" id="pic_desc_5" placeholder="Profile Image 5 Description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_profile_img_6" title="Preview Image" src="{{ asset('pilotNoImage.png') }}" alt="Preview profile_img_6 Image" width="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="pic_desc_6">Description</label>
                            <textarea rows="8" class="form-control {{ $errors->has('pic_desc_6') ? 'is-invalid' : '' }}" name="pic_desc_6" id="pic_desc_6" placeholder="Profile Image 6 Description"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="form-group">
                <label class="required" for="services">{{ trans('cruds.CompanyManagement.fields.services') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea rows="15" style="resize: none; width: 100%" name="description" id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"></textarea>
            ...
            <div class="form-group">
                ...
                <textarea rows="6" class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description" id="short_description"></textarea>
            ...
            <div class="form-group">
                <label for="working_hours">{{ trans('cruds.CompanyManagement.fields.working_hours') }}</label>
                <textarea rows="4" style="resize: none; width: 100%" name="working_hours" id="working_hours" class="form-control {{ $errors->has('working_hours') ? 'is-invalid' : '' }}"></textarea>
                ...
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="press_release_1[subject]" id="press_release_1_subject" value="{{ old('press_release_1.subject') }}">

                            <label for="press_release_1_date">Date</label>
                            <input class="form-control" type="date" name="press_release_1[date]" id="press_release_1_date" value="{{ old('press_release_1.date') }}">

                            <label for="press_release_1">Description</label>
                            <textarea rows="8" class="form-control" name="press_release_1[content]" id="press_release_1_content" placeholder="Add your press release URL or content here">{{ old('press_release_1.content') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="press_release_2[subject]" id="press_release_2_subject" value="{{ old('press_release_2.subject') }}">

                            <label for="press_release_2_date">Date</label>
                            <input class="form-control" type="date" name="press_release_2[date]" id="press_release_2_date" value="{{ old('press_release_2.date') }}">

                            <label for="press_release_2">Description</label>
                            <textarea rows="8" class="form-control" name="press_release_2[content]" id="press_release_2_content" placeholder="Add your press release URL or content here">{{ old('press_release_2.content') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="press_release_3[subject]" id="press_release_3_subject" value="{{ old('press_release_3.subject') }}">

                            <label for="press_release_3_date">Date</label>
                            <input class="form-control" type="date" name="press_release_3[date]" id="press_release_3_date" value="{{ old('press_release_3.date') }}">

                            <label for="press_release_3">Description</label>
                            <textarea rows="8" class="form-control" name="press_release_3[content]" id="press_release_3_content" placeholder="Add your press release URL or content here">{{ old('press_release_3.content') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="profile_pic_box">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="dc_articles_0_title">Title</label>
                            <input class="form-control mb-2" type="text" name="dc_articles[0][title]" id="dc_articles_0_title" value="{{ old('dc_articles.0.title') }}">
                            <textarea rows="2" class="form-control" name="dc_articles[0][article]" id="dc_articles_0_article" placeholder="Add your Droning Company Article URL here">{{ old('dc_articles.0.article') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="profile_pic_box">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="dc_articles_1_title">Title</label>
                            <input class="form-control mb-2" type="text" name="dc_articles[1][title]" id="dc_articles_1_title" value="{{ old('dc_articles.1.title') }}">
                            <textarea rows="2" class="form-control" name="dc_articles[1][article]" id="dc_articles_1_article" placeholder="Add your Droning Company Article URL here">{{ old('dc_articles.1.article') }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="profile_pic_box">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="dc_articles_2_title">Title</label>
                            <input class="form-control mb-2" type="text" name="dc_articles[2][title]" id="dc_articles_2_title" value="{{ old('dc_articles.2.title') }}">
                            <textarea rows="2" class="form-control" name="dc_articles[2][article]" id="dc_articles_2_article" placeholder="Add your Droning Company Article URL here">{{ old('dc_articles.2.article') }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="profile_pic_box">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="dc_articles_3_title">Title</label>
                            <input class="form-control mb-2" type="text" name="dc_articles[3][title]" id="dc_articles_3_title" value="{{ old('dc_articles.3.title') }}">
                            <textarea rows="2" class="form-control" name="dc_articles[3][article]" id="dc_articles_3_article" placeholder="Add your Droning Company Article URL here">{{ old('dc_articles.3.article') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="metakeyword">{{ trans('cruds.pilotProfile.fields.metakeyword') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea name="metadescription" id="metadescription" class="form-control {{ $errors->has('metadescription') ? 'is-invalid' : '' }}" rows="4" style="resize: none; width: 100%"></textarea>
            ...
            <div class="form-group">
                <button class="btn btn-success" type="submit">{{ trans('global.add') }}</button>
