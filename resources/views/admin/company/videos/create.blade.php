    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pilot_videos.store") }}" enctype="multipart/form-data" onsubmit="return checkValidation();">
            ...
            <div class="form-group">
                ...
                <div class="d-block custom-control custom-radio mr-2">
                    <input type="radio" class="custom-control-input" name="position" id="position1" value="Main" required>
                    <label class="custom-control-label" for="position1">Main</label>
                </div>
                <div class="d-block custom-control custom-radio mr-2">
                    <input type="radio" class="custom-control-input" name="position" id="position2" value="Gallery">
