...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.favelBoxesContents.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.favel-footnote-boxes.content.store", [$favelbox->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">      
                @if($favelbox->slug == "articles") 
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" value="">
                        @if($errors->has('title'))
                ...
                @endif  
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control {{ $errors->has('page_video_link') ? 'is-invalid' : '' }}" name="page_video_link" value="">
