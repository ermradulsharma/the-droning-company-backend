    ...
    <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 required" name="user_id" id="user_id" required>
                    ...
                    <option value="{{ $user->id }}" {{ old('user_id', $event->user_id) === (int) $user->id ? 'selected' : '' }}>{{ $user->first_name .' '.$user->last_name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title_to_generate_slug" value="{{ old('title', $event->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="generated_slug" value="{{ old('slug', $event->slug) }}">
                @if($errors->has('slug'))
                <div class="invalid-feedback">
                    {{ $errors->first('slug') }}
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('event_type') ? 'is-invalid' : '' }}" name="event_type" id="event_type">
                            ...
                            <option value="{{ $key }}" {{ old('status', $event->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('event_start') ? 'is-invalid' : '' }}" type="datetime-local" name="event_start" id="event_start" value="{{ old('event_start', $event->event_start) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('event_end') ? 'is-invalid' : '' }}" type="datetime-local" name="event_end" id="event_end" value="{{ old('event_end', $event->event_end) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('cost') ? 'is-invalid' : '' }}" type="text" name="cost" id="cost" value="{{ old('cost', $event->cost) }}">
                        @if($errors->has('cost'))
                        <div class="invalid-feedback">
                            {{ $errors->first('cost') }}
                        </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="street_add" id="street_add" value="{{ old('street_add', $event->street_add) }}">
                        @if($errors->has('street_add'))
                        <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('suite') ? 'is-invalid' : '' }}" type="text" name="suite" id="suite" value="{{ old('suite', $event->suite) }}">
                        @if($errors->has('suite'))
                        <div class="invalid-feedback">
                            {{ $errors->first('suite') }}
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $event->phone_number) }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('contact_email') ? 'is-invalid' : '' }}" type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', $event->contact_email) }}">
            ...
            <div class="form-group">
                <label for="event_link">Event URL</label>
                <input class="form-control {{ $errors->has('event_link') ? 'is-invalid' : '' }}" type="text" name="event_link" id="event_link" value="{{ old('event_link', $event->event_link) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('event_video') ? 'is-invalid' : '' }}" type="text" name="event_video" id="event_video">{{ old('event_video', $event->event_video) }}</textarea>
                ...
                <div class="profile_pic_box">
                    ...
                    <div class="form-group card-data">
                        <div class="custom-file" style="height: auto;">
                            <img id="output_image" title="Preview Image" src="{{ $event->image ? asset($event->image) : asset('pilotNoImage.png') }}" alt="Featured {{ trans('cruds.event.fields.image') }}" width="100">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_1" title="Preview Image" src="{{ $event->gallery_img_1 ? asset($event->gallery_img_1) : asset('pilotNoImage.png') }}" alt="gallery_img_1 Preview Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_2" title="Preview Image" src="{{ $event->gallery_img_2 ? asset($event->gallery_img_2) : asset('pilotNoImage.png') }}" alt="Preview gallery_img_2 Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_3" title="Preview Image" src="{{ $event->gallery_img_3 ? asset($event->gallery_img_3) : asset('pilotNoImage.png') }}" alt="Preview gallery_img_3 Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_4" title="Preview Image" src="{{ $event->gallery_img_4 ? asset($event->gallery_img_4) : asset('pilotNoImage.png') }}" alt="Preview gallery_img_4 Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_5" title="Preview Image" src="{{ $event->gallery_img_5 ? asset($event->gallery_img_5) : asset('pilotNoImage.png') }}" alt="Preview gallery_img_5 Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="profile_pic_box">
                        ...
                        <div class="form-group card-data">
                            <div class="custom-file" style="height: auto;">
                                <img id="output_gallery_img_6" title="Preview Image" src="{{ $event->gallery_img_6 ? asset($event->gallery_img_6) : asset('pilotNoImage.png') }}" alt="Preview gallery_img_6 Image" width="100">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $event->meta_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}" type="text" name="meta_keyword" id="meta_keyword" value="{{ old('meta_keyword', $event->meta_keyword) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{{ old('meta_description', $event->meta_description) }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-form-label">
                    <div class="form-check form-check-inline mr-1">
                        <input name="is_featured" class="form-check-input" id="inline-checkbox1" type="checkbox" value="1" {{ $event->is_featured==1 ? 'checked':'' }}>
