...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Account Activation | The Droning Company</title>
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" class="display-width" width="100%" style="width:auto !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="center" valign="middle" class="MsoNormal" style="color:#FFFFFF;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:13px;font-weight:600;letter-spacing:1px;">
                        ...
                        <tr>
                            <td align="center">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%">
                                    <tr>
                                        <td align="center" style="padding:0 30px;">
                                            <table align="center" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0" class="display-width" style="border-radius:5px" width="600">
                                                <tbody>
                                                    <tr>
                                                        <td height="30"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="80%">
                                                                <tr>
                                                                    <td align="center" class="MsoNormal" style="color:#333333;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:25px;font-weight:600;letter-spacing:1px;line-height:35px;text-transform:capitalize;">
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="MsoNormal" style="color:#666666;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;line-height:24px;">
                                                                        We're excited to have you started. First, you need to confirm your account. Just press the button below:
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="20"></td>
                                                                    ...
                                                                    <td align="center" class="button-width">
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="middle" class="MsoNormal" style="color:#000000;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:13px;font-weight:bold;letter-spacing:1px;padding:7px 15px;text-transform:uppercase;">
                                                                                <a href="{{$action_url}}" style="color:#000000;text-decoration:none;">Confirm Account</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="MsoNormal" style="color:#000;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;letter-spacing:1px;line-height:24px;text-transform:uppercase;">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="MsoNormal" style="color:#ffffff;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;line-height:24px;background: #000;padding: 5px;border: dotted 2px #fecd0e;">
                                                                    <span style="color:#ffffff;">{{$action_url}}</span>
                                                                </td>
                                                            </tr>
                                                            {{-- <tr>
                                                                <td height="20"></td>
                                                            ...
                                                            {{-- <tr>
                                                                <td align="center" class="MsoNormal" style="color:#666666;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;line-height:24px;">
                                                                    ...
                                                                    For General Info: <a href="mailto:info@thedroningcompany" style="color:#333333;">info@thedroningcompany</a>
                                                                    For Support: <a href="mailto:wehear@thedroningcompany" style="color:#333333;">wehear@thedroningcompany</a><br />
                                                                </td>
                                                            </tr> --}}
                                                            {{-- <tr>
                                                                <td height="15"></td>
                                                            ...
                                                            {{-- <tr>
                                                                <td align="center" class="MsoNormal" style="color:#666666;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;line-height:24px;">
                                                                    Please <span style="color:#333333; text-decoration: underline; "><a href="#" style="color:#333333; ">Sign in</a></span> to Your account
                                                                </td>
                                                            </tr> --}}
                                                            <tr>
                                                                <td height="45"></td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="MsoNormal" style="color:#666666;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:10px;line-height:24px;">
                                                                    ...
                                                                    <span style="color:#333333; text-decoration: underline; ">
                                                                        <a href="{{$action_url}}" style="color:#333333; ">{{$action_url}}</a></span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
