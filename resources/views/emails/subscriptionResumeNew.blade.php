...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Membership Resumed | TheDroningCompany.com</title>
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="25%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                            <tr>
                                                                <td align="center" valign="middle">
                                                                    <a href="www.thedroningcompany.com" style="color:#ffffff;text-decoration:none;">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="80%">
                                                                <tr>
                                                                    <td align="center" class="MsoNormal" style="color:#333333;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:20px;font-weight:600;letter-spacing:1px;line-height:35px;text-transform:capitalize;">
                                                                        Congratulations, Subscription Resumed!
                                                                    </td>
                                                                </tr>                                                                   
                                                                <tr>
                                                                    <td height="20"></td>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="MsoNormal" style="color:#666666;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;line-height:24px;">
                                                                        We have resumed your The Droning Company subscription which will auto renewed on <strong> {{$renew_at}}</strong>.  
                                                                    </td>                                               
                                                                </tr>
                                                                <tr>
                                                                    <td height="20"></td>
                                                                        ...
                                                                        <table align="center" bgcolor="#fecd0e" border="0" cellspacing="0" cellpadding="0" class="display-button" style="border-radius:5px;"> <!-- USING TABLE AS BUTTON -->
                                                                            <tr>
                                                                                <td align="center" valign="middle" class="MsoNormal" style="color:#000000;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:13px;font-weight:bold;letter-spacing:1px;padding:7px 15px;text-transform:uppercase;">
                                                                                    <a href="{{$action_url}}" style="color:#000000;text-decoration:none;">Login Your Account</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
...
<br />
 <span style="color:#333333; text-decoration: underline; "><a href="{{$action_url}}" style="color:#333333; ">{{$action_url}}</a></span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
